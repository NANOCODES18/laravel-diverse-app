...
<!-- Mirrored from 127.0.0.1:8000/about by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 19 Jul 2023 20:44:24 GMT -->
...
<head>
  ...
  <link href="static/images/favicon.ico" rel="shortcut icon" type="image/x-icon">
   ...
   <link href="static/imported-css.css" rel="stylesheet">
    <link href="static/css2/plugins.css" rel="stylesheet"/>
    ...
    <link href="static/general8195.css_id%3d12438.css" rel="stylesheet"/>
    <link href="static/css2/fontawesome.css" rel="stylesheet"/>
     ...
     <div class="row">
      <div class="col-lg-12" data-animate="bounceInDown" style="max-width: 970px;margin: auto;">
       <h2 class="tup text-center" style="font-size: 23px; margin-bottom: 0; color: #fff !important;">
        WHY CHOOSE {{$company_features? $company_features->companyname :"No company name set"}}?
       </h2>
       <p class="text-center" style="color: #fff !important;">
        In {{$company_features? $company_features->companyname :"No company name set"}},we securely Manage  investors stock as an asset management company that we are by combining our deep knowledge of local markets with the power of coordinated global oversight to derive better investment outcomes for our customers.
       ...
       <div class="in-margin-medium-top@s">
        <div class="uk-grid" data-uk-grid="">
         <div class="uk-width-expand@s uk-width-2-5@m uk-card-media-right uk-cover-container uk-first-column">
          <img alt="sample-image" class="uk-width-1-1 uk-margin-remove-bottom" src="static/img/in-wave-image-2.jpg"/>
         </div>
          ...
          <div class="">
           ...
           <div class="uk-child-width-1-3@m uk-text-center uk-visible@m uk-grid" data-uk-grid="">
            <div class="uk-first-column">
             <img alt="wave-award" src="static/img/in-wave-award.svg"/>
       ...
       <div class="m-b-40 f15">
        ...
        <p style="color: #fff !important">
         We’re proud to be an asset management company whose
                                ...
                                and a long-term vision. At {{$company_features? $company_features->companyname :"No company name set"}} Group Investments, our vision, mission and
   ...
   <section style="padding-top: 25px; padding-bottom: 35px;">
    <div class="container">
     <div class="row align-items-center">
      ...
      <div class="col-lg-4">
       <img alt="" src="static/site-images/compressed-assets/image-4-compressed.jpg" style="width: 100% !important;"/>
      </div>
     </div>
       ...
       <div class="uk-width-expand@m f-cont_888ji98">
        <div class="uk-grid-medium uk-child-width-1-4@s uk-child-width-1-5@m uk-text-center in-client-logo-3 uk-grid" data-uk-grid="">
         <div class="uk-tile uk-tile-default uk-first-column">
          <img alt="client-logo" class="uk-margin-remove" height="42" src="static/img/in-wave-media-1.svg" width="147"/>
         </div>
         <div class="uk-tile uk-tile-default">
          <img alt="client-logo" class="uk-margin-remove" height="42" src="static/img/in-wave-media-2.svg" width="147"/>
         </div>
         <div class="uk-tile uk-tile-default">
          <img alt="client-logo" class="uk-margin-remove" height="42" src="static/img/in-wave-media-3.svg" width="147"/>
         </div>
         <div class="uk-tile uk-tile-default">
          <img alt="client-logo" class="uk-margin-remove" height="42" src="static/img/in-wave-media-4.svg" width="147"/>
         </div>
         <div class="uk-tile uk-tile-default uk-visible@m">
          <img alt="client-logo" class="uk-margin-remove" height="42" src="static/img/in-wave-media-5.svg" width="147"/>
         </div>
        </div>
       </div>
      </div>
     ...
     <div class="row client-logos carousel-description-clients carousel-description-style">
      ...
      <div class="col-lg-8">
       <div class="carousel dots-grey tyu6ytyujh" data-arrows="false" data-items="4">
        <div>
         <a href="about.html#">
          <img alt="" src="static/site-images/logos/coinone-1.svg"/>
         </a>
        </div>
        <div>
         <a href="about.html#">
          <img alt="" src="static/site-images/logos/plasmapay-1.svg"/>
         </a>
        </div>
        <div>
         <a href="about.html#">
          <img alt="" src="static/site-images/logos/bbva-2019.svg"/>
         </a>
        </div>
        <div>
         <a href="about.html#">
          <img alt="" src="static/site-images/logos/montex-network-cryptocurrency-connecting.svg"/>
         </a>
        </div>
        <div>
         <a href="about.html#">
          <img alt="" src="static/site-images/logos/zcash.svg"/>
         </a>
        </div>
        <div>
         <a href="about.html#">
          <img alt="" src="static/site-images/logos/the-blockchain-group-tbg.svg"/>
         </a>
        </div>
        <div>
         <a href="about.html#">
          <img alt="" src="static/site-images/logos/waves-6.svg"/>
         </a>
        </div>
        <div>
         <a href="about.html#">
          <img alt="" src="static/site-images/logos/keep-solutions.svg"/>
         </a>
        </div>
        <div>
         <a href="about.html#">
          <img alt="" src="static/site-images/logos/huobi-1.svg"/>
         </a>
        </div>
        <div>
         <a href="about.html#">
          <img alt="" src="static/site-images/logos/ledger-new-logo-.svg"/>
         </a>
        </div>
       </div>
      </div>
     ...
     <div class="uk-grid-large uk-flex uk-flex-middle uk-grid" data-uk-grid="">
      <div class="uk-width-1-2@m uk-first-column">
       <div class="uk-margin-bottom hide-on-mobile yuwj8jwkk2ikwlw">
        <a class="uk-button in-button-app" href="about.html#kkssks">
         <img alt="monee-mastercard" class="uk-align-center btc-crypto-logo" data-src="img/monee-payment-mastercard.svg" data-uk-img="" height="32" src="static/img/awards/alkar.svg" width="103"/>
        </a>
        <a class="uk-button in-button-app uk-margin-medium-left" href="about.html#kkssks">
         <img alt="monee-paypal" class="uk-align-center" data-src="img/monee-payment-paypal.svg" data-uk-img="" height="32" src="static/img/awards/brandywine-realty-24808.svg" width="103"/>
        </a>
        <a class="uk-button in-button-app uk-margin-medium-left uk-visible@m" href="about.html#kkssks">
         <img alt="monee-unionpay" class="uk-align-center" data-src="img/monee-payment-unionpay.svg" data-uk-img="" height="32" src="static/img/awards/multex-investor.svg" width="103"/>
        </a>
       </div>
      ...
      <div class="uk-width-1-2@m">
       <img alt="wave-mockup" class="uk-align-center uk-align-left@m" height="330" src="static/img/in-wave-mockup-5.png" width="533"/>
      </div>
     </div>
    </div>
   </div>
      ...
      <div class="col-lg-7">
       <div class="carousel arrows-visibile testimonial testimonial-single testimonial-left" data-animate-in="fadeIn" data-animate-out="fadeOut" data-arrows="false" data-items="1">
        <div class="testimonial-item">
         <img alt="" src="static/img/reviewer2.jpg"/>
         <p>
          I've had incredible customer service since i started investing here, I'm a repeat
                                    investor. I've been investng with {{$company_features? $company_features->companyname :"No company name set"}} Groups Investments for nearly 3
        ...
        <div class="testimonial-item">
         <img alt="" src="static/img/reviewer3.jpg"/>
         <p>
          Transparent, profitable, and reliable bitcoin investment company that will make you
                                    real money. Thanks to all of you at {{$company_features? $company_features->companyname :"No company name set"}} Group for the excellent
                                    service.
         </p>
         <span>
          Diane Podmanik
        ...
        <div class="testimonial-item">
         <img alt="" src="static/img/reviewer5.jpg"/>
         <p>
          I have always been searching for an opportunity to earn on bitcoin and finally I
                                    found {{$company_features? $company_features->companyname :"No company name set"}} Group and they have proven to be very reliable since i've
       ...
       <div class="uk-grid uk-grid-small" data-uk-grid="">
        ...
        <div class="uk-width-expand">
         <h3 class="tup" style="color: #fff !important">
          Why {{$company_features? $company_features->companyname :"No company name set"}}?
         </h3>
         <p style="color: #fff !important">
      ...
      <div class="col-lg-4" style="">
       ...
       <span>
        Empowering investors by providing them an avenue for controlling their financial future by
                            ...
                            traditional assets.
                            {{$company_features? $company_features->companyname :"No company name set"}} Group is dedicated to helping investors around the world reach
      ...
      <div class="uk-width-1-1">
       <div class="uk-card uk-card-primary uk-border-rounded uk-background-cover" style="background-image: linear-gradient(#012c6d80, #012c6da3),url(site-images/WhatWeDoPeople2x.html);">
        <div class="uk-card-body">
         ...
         <a class="uk-button uk-button-primary uk-border-rounded c-w" href="about.html#">
          Open an
                                    Account Now
         </a>
        </div>
       ...
       <div class="row">
        <div class="col-lg-12" data-animate="fadeIn">
         We’re proud to be an asset management company
                                whose culture is driven by strong values and a long-term vision. At {{$company_features? $company_features->companyname :"No company name set"}}
         ...
         <br/>
         <br/>
         {{$company_features? $company_features->companyname :"No company name set"}} Group was founded on a simple but revolutionary idea that an
                                investment company
                                should be run for the sole benefit of its investors. And so {{$company_features? $company_features->companyname :"No company name set"}} Group was
                                designed to be
                                different, removing outside owners and outside interests from the equation. Because of
                                our investor-owned structure, {{$company_features? $company_features->companyname :"No company name set"}} Group's success can only be measured by
                                your success.
        </div>
        <div class="col-lg-12" data-animate="fadeIn">
         Low costs, a long-term orientation, and focus
                                on your goals are at the core of
                                {{$company_features? $company_features->companyname :"No company name set"}} Group's investing philosophy, and not just because they sound good.
                                They're essential
         ...
         <br/>
         <br/>
         {{$company_features? $company_features->companyname :"No company name set"}} Group's mission is to help investors reach their goals, and that
                                means access to
         ...
         <br/>
         <br/>
         Strategy matters. {{$company_features? $company_features->companyname :"No company name set"}} Group's approach to managing investments on behalf
                                of our clients is
...
<!-- Mirrored from 127.0.0.1:8000/about by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 19 Jul 2023 20:49:16 GMT -->
</html>
